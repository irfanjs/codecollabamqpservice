package com.infy.ci.codecollabamqpservice;
...
@Component
@Configuration
@RequestMapping("/codecollabtestdata")
public class CodeCollabAmqpRestController {
	...
	private final Logger logger = LoggerFactory.getLogger(CodeCollabAmqpRestController.class);
	

	@RequestMapping(value = "/{projectid}/codecollab/aggregate", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/codecollab/modulewise", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/codecollab/week", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/codecollab/month", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/codecollab/custom", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/codecollab/{buildnumber}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
